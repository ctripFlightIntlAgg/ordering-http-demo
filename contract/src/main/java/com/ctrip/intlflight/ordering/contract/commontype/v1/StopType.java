...
@XmlType(name = "StopType", namespace = "urn:com:ctrip:flight:intl:booking:order:contract:commontype:v1", propOrder = {
    "airport",
    "duration",
    "arrivalDateTime"
})
...
public class StopType implements Serializable {
    ...
    public StopType() {
        this.arrivalDateTime = new java.util.GregorianCalendar(1, Calendar.JANUARY, 1, 0, 0, 0);
        this.arrivalDateTime.setTimeZone(sun.util.calendar.ZoneInfo.getTimeZone("UTC"));
    }
